...
class VisitanteResourceIT {
    ...
    private static final String DEFAULT_NOMBRE_VISITANTE = "AAAAAAAAAA";
    private static final String UPDATED_NOMBRE_VISITANTE = "BBBBBBBBBB";
    ...
    public static Visitante createEntity(EntityManager em) {
        Visitante visitante = new Visitante().nombreVisitante(DEFAULT_NOMBRE_VISITANTE).apellido(DEFAULT_APELLIDO).phone(DEFAULT_PHONE);
        return visitante;
    }
    ...
    public static Visitante createUpdatedEntity(EntityManager em) {
        Visitante visitante = new Visitante().nombreVisitante(UPDATED_NOMBRE_VISITANTE).apellido(UPDATED_APELLIDO).phone(UPDATED_PHONE);
        return visitante;
    }
    ...
    void createVisitante() throws Exception {
        ...
        assertThat(testVisitante.getNombreVisitante()).isEqualTo(DEFAULT_NOMBRE_VISITANTE);
    ...
    void getAllVisitantes() throws Exception {
        ...
        restVisitanteMockMvc
            ...
            .andExpect(jsonPath("$.[*].nombreVisitante").value(hasItem(DEFAULT_NOMBRE_VISITANTE)))
    ...
    void getVisitante() throws Exception {
        ...
        restVisitanteMockMvc
            ...
            .andExpect(jsonPath("$.nombreVisitante").value(DEFAULT_NOMBRE_VISITANTE))
    ...
    void putNewVisitante() throws Exception {
        ...
        updatedVisitante.nombreVisitante(UPDATED_NOMBRE_VISITANTE).apellido(UPDATED_APELLIDO).phone(UPDATED_PHONE);
        ...
        Visitante testVisitante = visitanteList.get(visitanteList.size() - 1);
        assertThat(testVisitante.getNombreVisitante()).isEqualTo(UPDATED_NOMBRE_VISITANTE);
    ...
    void fullUpdateVisitanteWithPatch() throws Exception {
        ...
        partialUpdatedVisitante.nombreVisitante(UPDATED_NOMBRE_VISITANTE).apellido(UPDATED_APELLIDO).phone(UPDATED_PHONE);
